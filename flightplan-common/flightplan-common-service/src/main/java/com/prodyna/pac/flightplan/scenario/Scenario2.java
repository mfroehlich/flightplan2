...
public class Scenario2 implements Scenario {
    ...
    public String[] getSqlStatements() {
        return new String[] {
                ...
                "insert into user (id, email, first_name, last_name, password, user_name) values ('2', 'test@prodyna.com', 'test', 'test', 'CY9rzUYh03PK3k6DJie09g==', 'test')",
                ...
                "insert into pilot_to_aircraft_type (pilot_id, aircraft_type_id) values ('2', '2')",
                ...
                "insert into plane (id, name, number_plate, aircraft_type) values ('2', 'Plane 2', 'PLA-NE-2', '2')",
