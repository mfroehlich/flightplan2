...
public class Scenario3 implements Scenario {
    ...
    public String[] getSqlStatements() {
        return new String[] {
                ...
                "insert into user (id, email, first_name, last_name, password, user_name) values ('1', 'user1@prodyna.com', 'Markus1', 'Fröhlich1', 'CY9rzUYh03PK3k6DJie09g==', 'user1')",
                "insert into user (id, email, first_name, last_name, password, user_name) values ('2', 'user2@prodyna.com', 'Markus2', 'Fröhlich2', 'CY9rzUYh03PK3k6DJie09g==', 'user2')",
                "insert into user (id, email, first_name, last_name, password, user_name) values ('3', 'user3@prodyna.com', 'Markus3', 'Fröhlich3', 'CY9rzUYh03PK3k6DJie09g==', 'user3')",
                ...
                "insert into pilot_to_aircraft_type (pilot_id, aircraft_type_id) values ('2', '1')",
                "insert into pilot_to_aircraft_type (pilot_id, aircraft_type_id) values ('3', '1')",
                ...
                "insert into plane (id, name, number_plate, aircraft_type) values ('3', 'Plane 3', 'PLA-NE-3', '1')",
